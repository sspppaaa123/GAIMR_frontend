...
export default class PostScreen extends React.Component {
    ...
    geoSuccess = (pos) => {
        ...
        geoUrl = "https://us1.locationiq.com/v1/reverse.php?key=pk.341dc942c342bda9abbcc8cb7418f7e3"
        geoUrl += "&lat=" + lat + "&lon=" + lon + "&format=json"
        fetch(geoUrl, {
            method: "GET",
            headers: {
            ...
            .then((respJSON) => {
                ...
                this.setLocation(respJSON.address)
            })
